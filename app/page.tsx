...
import { getHomeData, getAllFeatures, getAllServices } from '@/lib/sanity'
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {homeData?.introduction && (
        <section className="py-20 md:py-32 bg-gradient-to-b from-background via-background to-secondary/30 relative overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-[450px] bg-gradient-to-br from-secondary to-primary/10 rounded-2xl overflow-hidden animate-slide-in-right group hover:shadow-2xl transition-all duration-500">
                {/* Image will be displayed here when connected to Sanity */}
      ...
      {/* CTA Section */}
      <section className="py-24 md:py-40 bg-gradient-to-r from-primary via-primary/85 to-primary/90 text-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center animate-fade-in-up relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 drop-shadow-lg text-balance">Schedule Your Visit Today</h2>
          ...
          <Button asChild size="lg" className="transition-all hover:scale-105 hover:shadow-2xl bg-white text-primary hover:bg-gray-50 font-semibold px-8 py-3">
